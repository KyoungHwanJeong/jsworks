...
for(let i=0; i<score.length; i++){
  kor_sum[0] += score[i][0];
  math_sum[1] += score[i][1];
}
avgScore[0] = sumScore[0] / score.length;
avgScore[1] = sumScore[1] / score.length;

document.write("국어 합계: " + kor_sum[0] + "<br>");
document.write("수학 합계: " + math_sum[1] + "<br>");
document.write("국어 평균: " + kor_avg[0] + "<br>");
document.write("수학 평균: " + math_avg[1] + "<br>");
